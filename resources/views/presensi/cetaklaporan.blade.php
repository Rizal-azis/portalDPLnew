...
<body class="A4">
    ...
    <section class="sheet padding-10mm">
        ...
        <table style="width: 100%">
            <tr>
                <td style="width: 30px">
                    <img src="{{ asset('assets/img/login/daksa.png') }}" width="110" height="110" alt="">
                </td>
                <td>
                    <span id="title">
                        LAPORAN KINERJA KARYAWAN<br>
                        PERIODE {{ strtoupper($namabulan[$bulan]) }} {{ $tahun }}<br>
                        PT. DAKSA PANGUPAKARA LARAS<br>
                    </span>
                    <span><i>Jl. Bumiputra IV No.32, RT.3/RW.18, Rawamangun, Kec. Pulo Gadung, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13240</i></span>
                </td>
            </tr>
        </table>
        ...
        <table width="100%" style="margin-top:100px">
            ...
            <tr>
                <td style="text-align: center; vertical-align:bottom" height="100px">
                    <u>Arif Hidayat</u><br>
                    <i><b>Finance Manager</b></i>
                </td>
                <td style="text-align: center; vertical-align:bottom">
                    <u>Rizky Muhammad Ramdan Sidiq</u><br>
                    <i><b>Direktur</b></i>
                </td>
            </tr>
        </table>
