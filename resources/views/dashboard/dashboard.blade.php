...
@section('content')
    ...
    <div class="section mt-2" id="presence-section">
                        ...
                        <div class="card-body">
                            <div class="presencecontent">
                                ...
                                <div class="presencedetail">
                                    <h4 class="presencetitle">Start Lembur</h4>
                                    <span>{{ $presensihariini != null ? $presensihariini->jam_in : 'Bukti' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card gradasired">
                        <div class="card-body">
                            <div class="presencecontent">
                                ...
                                <div class="presencedetail">
                                    <h4 class="presencetitle">Beres Lembur</h4>
                                    <span>{{ $presensihariini != null && $presensihariini->jam_out != null ? $presensihariini->jam_out : 'Bukti' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div id="rekappresensi">
            <h3>Rekap Kinerja Bulan {{ $namabulan[$bulanini] }} Tahun {{ $tahunini }}</h3>
            <div class="row">
                <div class="col-3">
                    <div class="card">
